...
(function() {
  ...
  var CanvasInput = window.CanvasInput = function(o) {
    ...
    self._x = o.x || 0;
    self._y = o.y || 0;
    self._renderOnMain= o.renderOnMain || 0;
  ...
  //  transMx:0,
    ...
    render: function() {
      var self = this,
        ctx = self._renderOnMain? 
         self._ctx : self._renderCtx,
        w = self.outerW,
        h = self.outerH,
      ...
      if(self._renderOnMain) {
       saved=1;
       trans=ctx.getTransform();
      ...
      self._drawTextBox(function() {
        ...
        if (!this._renderOnMain && self._ctx) {
    ...
    _updateCanvasWH: function() {
      ...
      if (self._ctx && !self._renderOnMain) {
