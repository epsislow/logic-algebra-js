...
const DOC_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { file: 'inline-logic.md', label: 'Inline logic (`inline [logic]`)', searchPrimary: 'logic inline.logic facts rules query use use as alias prolog owns modifier2 veh.wheeled', searchExtra: 'logts-play declarative knowledge base atoms variables backtracking OR clauses difference prolog doc(.character) prefixed import v.c.carWheel' },
