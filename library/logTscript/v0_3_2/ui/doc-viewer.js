...
const DOC_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { file: 'comp-canvas.md', label: 'Component canvas (`comp [canvas]`)', searchPrimary: 'canvas comp.canvas width height bgColor renderer set draw busy HTML 2d', searchExtra: 'logts-play Load and Run Devices panel widget redraw coalesce' },
