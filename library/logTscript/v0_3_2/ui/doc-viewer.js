...
const DOC_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { file: 'logic-runtime.md', label: 'Logic runtime (static / dynamic / mutations)', searchPrimary: 'logic runtime mutation { + - } tombstone dynamic overlay mutationFailed assert retract ground fact', searchExtra: 'logts-play Load and Run static dynamic effective KB comp logic inline world query warehouse move box' },
