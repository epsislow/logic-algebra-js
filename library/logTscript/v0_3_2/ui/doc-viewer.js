...
const DOC_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { file: 'logic-builtins.md', label: 'Logic built-ins', searchPrimary: 'logic builtins show count nth0 nth1 is member append length reverse sort', searchExtra: 'logts-play reserved predicate list member append length reverse sort count show nth0 nth1 is arithmetic' },
