...
const DOC_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { file: 'comp-logic.md', label: 'Component logic (`comp [logic]`)', searchPrimary: 'logic comp.logic program block exec redirect query pin myX set on raise', searchExtra: 'logts-play pipeline scoreIn modifier number text bool isJohnOwner johnOwns execCount doc(comp.logic)' },
