...
const DOC_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { file: 'plc.md', label: 'PLC (`inline [plc]` + `comp [plc]`)', searchPrimary: 'plc inline.plc comp.plc program scan START MOTOR IF THEN ELSIF', searchExtra: 'logts-play scanCount inputs outputs map wire key switch led latch retain' },
