...
- Static vs dynamic KB, `logic { + / - }`, tombstones, **`each`** / **`every`** mutation, tutorial game → [mini-monopoly-logic.md](mini-monopoly-logic.md), [logic-runtime.md](logic-runtime.md)
