...
wire[4] weights = 0010 + 0011 + 1100 + 0001   # w0..w3
...
comp [rotary] .rr:
    ...
    :
2w rr = .rr
.val = MUX(.rr, ^FFF, .osc:counter, \\1;15, \\2;15)
...
30w div= DIVIDE(.osc:counter, \\16)
30w div2= DIVIDE(div.0/15, \\16)

15w q = 1 < div.25/5 w1
15w q2 = 1< div2.25/5 w1
15w q3 = 1< div2.10/5 w1
...
pcb +[mgr]:
    ...
    comp [mem] .mem:
        ...
        length: 16
        on:1
        =  1;8 + 1;8 + \\5;8 + 1;8   + \\9;8 + 1;8 + \\13;8 + 1;8    + \\17;8 + 1;8 + \\3;8 + 111111010;16
        :
...
.pos:{
   dir=1
   set= .nxt #AND(.nxt, !EQ(.pos:get, 100))
}
...
.mem =  1;8 + 1;8 + \\5;8 + 1;8   + \\9;8 + 1;8 + \\13;8 + 1;8    + \\17;8 + 1;8 + \\3;8 + 111111010;16
...
.ttt:{
   ...
   data = 111111010
   rgb = ^f70
   set= press #AND(press, AND( !EQ(pos, 000)))
}
