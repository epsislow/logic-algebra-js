...
//console.log(charCode);
    ...
    for (let row = 0; row < 8; row++) {
      ...
      const rowByte = this.font[base + row] & 0x1F; // use only 5 bits

      // extract bits 4 → 0 (left → right)
