 ...
 * Also syncs run_tests.html script tags and test_runtime_bundle.js from test_scripts.json.
...
const RUN_TESTS_HTML = path.join(dir, 'run_tests.html');
const RUNTIME_BUNDLE = path.join(dir, 'test_runtime_bundle.js');
...
function writeRuntimeBundle() {
  ...
  const body = `/**
 * Auto-generated by node _gen_manifest.js — do not edit.
 * Source of truth: test_scripts.json
 */
