////////////// utils.js
const utils = {
    'charToASCII': function (letter) {
        return letter.charCodeAt(0);
    },
    'asciiToBinary': function (num) {
    ...
    'leftRotate': function (string, num) {
    ...
    'binaryAddition': function (stringA, stringB) {
...
var text = 'abc';
var description = 'Sha1 for text `'+text + '` is: '+ sha1(text);
