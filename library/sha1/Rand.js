   ...
   //     console.log('aa_£a',this.reg[placeId])
		...
		place: {
			icoList: {
				...
				'Sun':['certificate'],
				'Planet':['globe-asia','globe-europe','globe-africa','globe-america','circle','adjust','record-vinyl','circle'],
				'Moon':['adjust','cookie','circle'],
			...
			config: {
				...
				'type': {
					...
					'Solar system': ['Sun','Planet','Warp Gateway', 'Asteroid belt'],
					'Asteroid belt': ['Asteroid', 'Sunport Gateway','Resource Asteroid2'],
					'Asteroid': ['Space dock', 'Space colony'],
					'Planet': ['Moon','Sunport Gateway', 'Space colony', 'Space city', 'Space dock','Space station', 'City','Ring'],
					'Moon': ['Space colony', 'Space city', 'Space dock','Space station', 'City'],
